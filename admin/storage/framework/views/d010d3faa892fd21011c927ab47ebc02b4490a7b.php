            ...
            <div class="col-md-6 pd0 float-left">
                <div class="card card-primary">
                    ...
                    <?php endif; ?>
                     ...
                     <?php endif; ?>
                    <div class="card-body">
                        <form method="post" action="<?php echo e(url('save-nigunim-category')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            <div class="form-group row nShow mb-1">
                                <label class="col-md-4">Select Category</label>
                                <div class="col-md-8">
                                    <select class="form-control" name="nigunim_id" id="nigunim_id" readonly>
                                        ...
                                        <option value="<?php echo e($val->id); ?>" <?php echo e(( $val->name == 'Nigunim') ? 'selected' : ''); ?>><?php echo e($val->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                             ...
                             <div class="form-group row nShow mb-1">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="nigunim_category_name" placeholder="Category Name" id="nigumin_category_name">
                                </div>
                            </div>
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    <a id="<?php echo e($dt->id); ?>" href="javascript:" class="btn btn-info btn-sm edit"> <i class="fa fa-edit"></i> </a> <a id="<?php echo e($dt->id); ?>" onclick="return confirm('Are you sure to delete this Category?')" href="<?php echo e(url('delete-nigunim-category/'.$dt->id)); ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
                                </td>
                              </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/create_nigunim_category.blade.php ENDPATH**/ ?>