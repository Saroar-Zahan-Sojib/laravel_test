            ...
            <div class="col-md-6 pd0 float-left">
                <div class="card card-primary">
                    ...
                    <?php endif; ?>
                     ...
                     <?php endif; ?>
                    <div class="card-body">
                        <form method="post" action="<?php echo e(url('save-category')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/create_category.blade.php ENDPATH**/ ?>