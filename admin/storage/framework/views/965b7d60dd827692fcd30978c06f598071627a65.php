...
<script type="text/javascript">
     $(document).on("click", ".edit", function(){
      ...
      $.ajaxSetup({
        ...
        $.ajax({
            url: "<?php echo e(url('kol-rabeinu-feature-update')); ?>",
            method: "post",
            data: {
                id: id,
                status: status,
            ...
            success: function(rsp){
                ...
                if(rsp.error == false){
                    ...
                    setTimeout(function(){
                            window.location = "<?php echo e(url('set-feature-of-kol-rabeinu')); ?>"+"/"+category_id;
                    }, 2000);
                } else {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/kol_rabeinu_feature_update.blade.php ENDPATH**/ ?>