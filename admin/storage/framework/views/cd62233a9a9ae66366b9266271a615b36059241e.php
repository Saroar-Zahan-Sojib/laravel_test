            ...
            <div class="col-md-5 pd0 float-left">
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <!-- <a href="<?php echo e(url('question-list')); ?>" class="float-right">
                            ...
                            <div class="col-md-8 dnone examsd">
                                <div class="input-group">
                                    <select class="form-control" name="exam" id="exam" onchange="showQuestionList()">
                                        ...
                                        <?php if(Auth::user()->inst_status == 1): ?>
                                            ...
                                            <option value="<?php echo e($exams->id); ?>"><?php echo e($exams->name); ?> <?php echo e($exams->year); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $data['exams']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exams): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($exams->id); ?>"><?php echo e($exams->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                    <?php if(Auth::user()->inst_status != 1): ?>
                            ...
                            <div class="col-md-8 dnone testsd">
                                <div class="input-group">
                                    <select class="form-control" name="test" id="test" onchange="showQuestionList()">
                                        ...
                                        <option value="<?php echo e($tests->id); ?>"><?php echo e($tests->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="col-md-8 dnone Primary-School-Intermediate">
                                <div class="input-group">
                                    <select class="form-control" name="pclass" id="psi" required="" onchange="showQuestionList()">
                                        <option value="">Select</option>
                                        <?php $__currentLoopData = $data['classes_psi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-8 dnone University">
                                <div class="input-group">
                                    <select class="form-control" name="iclass" id="uni" required="" onchange="showQuestionList()" >
                                        <option value="">Select</option>
                                        <?php $__currentLoopData = $data['classes_uni']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cls->id); ?>"><?php echo e($cls->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                        ...
                        <div class="form-group row dnone nShow mb-1">
                            ...
                            <div class="col-md-8">
                                ...
                                <select class="form-control subj" id="subject_sh" onchange="showQuestionList()">
                                        ...
                                        <option value="">Select</option>
                                        <!-- <?php $__currentLoopData = $data['subjects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sbj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sbj->subject_id); ?>"><?php echo e($sbj->subject_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <select class="form-control subj" onchange="showQuestionList()">
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $data['subjects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sbj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sbj->id); ?>"><?php echo e($sbj->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                    <?php if(Auth::user()->inst_status != 1): ?>
        ...
        <div class="form-group row mb-3 mt-3">
            <div class="col-md-12">
                <table class="table table-bordered table-striped table-hover subjData">
                    <?php $__currentLoopData = $data['subjects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
        ...
        <div class="form-group row mb-3 mt-3">
            <div class="col-md-12">
                <table class="table table-bordered table-striped table-hover stdClsData">
                    <?php $__currentLoopData = $data['classes_uni']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($dt->name); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
$(document).on("change", "#psi", function(){
  ...
  //alert(class_id);
  $.ajax({
    url: "<?php echo e(url('selected_subject')); ?>",
    method: "post",
    dataType: 'json', 
...
$(document).on("click", ".AddExam", function(){
    ...
    '<div class="form-group row">'+
        '<div class="col-md-12">'+
            '<div class="input-group">'+
                ...
                '<a href="javascript:" class="input-group-append exam_test_submit" url="<?php echo e(url('exam-create')); ?>" tbl="exam">'+
                    '<span class="btn btn-primary">Submit</span>'+
                '</a>'+
            '</div>'+
        '</div>'+
    ...
    $.ajax({
        url: "<?php echo e(url('ExamTestListAjax')); ?>",
        method: "get",
        beforeSend: function(){
    ...
    '<div class="form-group row">'+
        '<div class="col-md-12">'+
            '<div class="input-group">'+
                ...
                '<a href="javascript:" class="input-group-append exam_test_submit" url="<?php echo e(url('test-create')); ?>" tbl="test">'+
                    '<span class="btn btn-primary">Submit</span>'+
                '</a>'+
            '</div>'+
        '</div>'+
...
$(document).on("click", ".showAllQuestion", function(){
    window.location = "<?php echo e(url('question-list')); ?>";
});
...
function showQuestionList(){
   ...
   // var class_id = $(".stdClass option:selected").val();
    ...
    if(exam_type && exam_id && class_id && subject_id){
        $.ajax({
            url: "<?php echo e(url('showQuestionList')); ?>/"+class_id+"/"+subject_id+"/"+exam_id+"/"+exam_type+"/"+year,
            method: "get",
            beforeSend: function(){
                    ...
                    $(data.data).each(function(){
                        ...
                        "<tr>"+
                            ...
                            "<td class='text-center text-wrap'>"+
                                '<a id="'+this.id+'" href="<?php echo e(url('questions-edit')); ?>-'+this.id+'" class="btn btn-info btn-sm"> <i class="fa fa-edit"></i> </a> <a id="'+this.id+'" href="javascript:" class="btn btn-danger btn-sm dlt"> <i class="fa fa-trash"></i> </a>';
                            "</td>"+
                        "</tr>";
                        sl++;
                    });
...
$(document).on("click", ".dlt", function(){
    ...
    var ts =$(this);
    $.ajax({
        url: "<?php echo e(url('delete_question')); ?>",
        method: "post",
        data: {id: id},
        beforeSend: function(){
            ts.find("span").removeClass("btn-primary btn-danger")
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\laravel\admin\resources\views/questions/create.blade.php ENDPATH**/ ?>