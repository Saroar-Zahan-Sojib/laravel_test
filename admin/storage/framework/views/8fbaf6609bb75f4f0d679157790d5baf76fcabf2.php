					...
					<form action="#" class="signin-form d-md-flex">
						<div class="half p-4 py-md-5">
				            ...
				            <div class="form-group mt-3">
				      			...
				      			Don't have an account? <a href="<?php echo e(url('registration')); ?>" style="color: #3490dc !important;">Create New</a>
				      		</div>
			            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/user/login.blade.php ENDPATH**/ ?>