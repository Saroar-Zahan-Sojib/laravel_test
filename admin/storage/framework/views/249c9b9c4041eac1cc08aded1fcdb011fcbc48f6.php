            ...
            <div class="col-md-6 pd0 float-left">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4><i class="fa fa-list"></i> Write Your Month</h4>
                    ...
                    <?php endif; ?>
                     ...
                     <?php endif; ?>
                    <div class="card-body">
                        <form method="post" action="<?php echo e(url('save-farbrengen-date')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            <div class="form-group row nShow mb-1">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" name="month" id="month">
                                        ...
                                        <?php $__currentLoopData = $month; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group row nShow mb-1">
                                <label class="col-md-4">Date Name</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="date" placeholder="Date Name" id="date">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td class="name"><?php echo e($dt->date); ?></td>
                                <td style="white-space: nowrap;">
                                    <a id="<?php echo e($dt->id); ?>" href="javascript:" class="btn btn-info btn-sm edit"> <i class="fa fa-edit"></i> </a> <a id="<?php echo e($dt->id); ?>" onclick="return confirm('Are you sure to delete this Category?')" href="<?php echo e(url('delete-category/'.$dt->id)); ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
                                </td>
                              </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/add_farbrengen_date.blade.php ENDPATH**/ ?>