                      ...
                      <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php else: ?> 
                                <td class="video"><video width="100px" height="80" muted><source src="<?php echo e(asset('/video_file/'.$dt->video)); ?>" type="video/mp4"></video></td>   
                                <?php endif; ?>    
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/file_list.blade.php ENDPATH**/ ?>