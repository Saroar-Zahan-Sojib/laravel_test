                                    ...
                                    <div class="form-group row nShow mb-1">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control" name="month" id="category_id">
                                                ...
                                                <option value="<?php echo e($val->id); ?>"><?php echo e($val->month); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row nShow mb-1">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control" name="date" id="category_id">
                                                <option>--Select--</option>
                                                <?php $__currentLoopData = $date; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($val->id); ?>"><?php echo e($val->date); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/add_farbrengen_file.blade.php ENDPATH**/ ?>