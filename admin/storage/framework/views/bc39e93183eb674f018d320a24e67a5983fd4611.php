                        ...
                        <?php echo csrf_field(); ?> -->
                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    <td><?php echo e($chumas->subcategory_name); ?></td>
                                    <td><a href="set-daily-shurim-date/<?php echo e($chumas->id); ?>/<?php echo e($chumas->subcategory_name); ?>" class="btn btn-primary">Set Date</a> </td>
                                  </tr>
                                  <tr>
                                    <td><?php echo e($tanaya->content_name); ?></td>
                                    <td><a href="set-daily-shurim-date/<?php echo e($tanaya->id); ?>/<?php echo e($tanaya->content_name); ?>" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo e($hayom_yom->content_name); ?></td>
                                    <td><a href="set-daily-shurim-date/<?php echo e($hayom_yom->id); ?>/<?php echo e($hayom_yom->content_name); ?>" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo e($inyonei_geulah->category_name); ?></td>
                                    <td><a href="set-daily-shurim-date/<?php echo e($inyonei_geulah->id); ?>/<?php echo e($inyonei_geulah->category_name); ?>" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo e($rambam->subcategory_name); ?></td>
                                    <td><a href="set-daily-shurim-date/<?php echo e($rambam->id); ?>/<?php echo e($rambam->subcategory_name); ?>" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo e($dof_yomi->subcategory_name); ?></td>
                                    <td><a href="set-daily-shurim-date/<?php echo e($dof_yomi->id); ?>/<?php echo e($dof_yomi->subcategory_name); ?>" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                </table>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/daily_shiurim.blade.php ENDPATH**/ ?>