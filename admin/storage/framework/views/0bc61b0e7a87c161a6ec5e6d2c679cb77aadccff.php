            ...
            <div class="col-md-6 pd0 float-left">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4><i class="fa fa-list"></i> Write Your Yomim Tovim</h4>
                    ...
                    <?php endif; ?>
                     ...
                     <?php endif; ?>
                    <div class="card-body">
                        <form method="post" action="<?php echo e(url('save-yomim-tovim')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            <div class="form-group row nShow mb-1">
                             ...
                             <div class="form-group row nShow mb-1">
                                <label class="col-md-4">Holiday Name</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="holiday_name" placeholder="Holiday Name" id="holiday_name">
                                </div>
                            </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td class="holiday_name"><?php echo e($dt->holiday_name); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/create_yomim_tovim.blade.php ENDPATH**/ ?>