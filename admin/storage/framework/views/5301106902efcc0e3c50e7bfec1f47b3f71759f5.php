                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    ...
                                    <td><a id="<?php echo e($dt->id); ?>" content_name="<?php echo e($dt->content_name); ?>" content_id="<?php echo e($dt->content_id); ?>" href="javascript:" class="btn btn-info btn-sm edit"> <i class='fa fa-save'></i> Submit </a></td>
                                  </tr>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        $.ajax({
            ...
            success: function(rsp){
                ...
                if(rsp.error == false){
                    ...
                    setTimeout(function(){
                            window.location = "<?php echo e(url('set-daily-shurim-date')); ?>"+"/"+content_id+"/"+content_name;
                    }, 2000);
                } else {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/daily_shiurim_set_date_for_content.blade.php ENDPATH**/ ?>