                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="row justify-content-between">
                            <div class="col-md-10">
                                <h4><i class="fa fa-list"></i> Set feature </h4>
                            </div>
                        ...
                        <?php echo csrf_field(); ?> -->
                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    <td><?php echo e($dt->content_name); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <input name="feature_status" <?php echo e(($dt->feature_status=="1")? "checked" : ""); ?> id="ad_Checkbox3" class="ads_Checkbox" type="checkbox" value="1" />
                                    </td>
                                    <td><a id="<?php echo e($dt->id); ?>" category_id="<?php echo e($dt->content_id); ?>" href="javascript:" class="btn btn-info btn-sm edit"> <i class='fa fa-save'></i> Submit </a></td>
                                  </tr>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script type="text/javascript">
     $(document).on("click", ".edit", function(){
      ...
      $.ajaxSetup({
        ...
        $.ajax({
            url: "<?php echo e(url('parshas-hashvua-feature-update')); ?>",
            method: "post",
            data: {
                id: id,
                status: status,
            ...
            success: function(rsp){
                ...
                if(rsp.error == false){
                    ...
                    setTimeout(function(){
                            window.location = "<?php echo e(url('set-feature-parshas-hashavua')); ?>"+"/"+category_id;
                    }, 2000);
                } else {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/parshas_hashavua_feature_update.blade.php ENDPATH**/ ?>