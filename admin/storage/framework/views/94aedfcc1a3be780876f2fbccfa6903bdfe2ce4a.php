                        ...
                        <?php echo csrf_field(); ?> -->
                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    <td><?php echo e($dt->subcategory_name); ?></td>
                                    ...
                                    <td><a id="<?php echo e($dt->id); ?>" subcategory_name="<?php echo e($dt->subcategory_name); ?>" subcategory_id="<?php echo e($dt->subcategory_id); ?>" href="javascript:" class="btn btn-info btn-sm edit"> <i class='fa fa-save'></i> Submit </a></td>
                                  </tr>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script type="text/javascript">
     $(document).on("click", ".edit", function(){
      ...
      $.ajaxSetup({
        ...
        $.ajax({
            url: "<?php echo e(url('daily-seuirm-val-update')); ?>",
            method: "post",
            data: {
                id: id,
                date: date,
            ...
            success: function(rsp){
                ...
                if(rsp.error == false){
                    ...
                    setTimeout(function(){
                            window.location = "<?php echo e(url('set-daily-shurim-date')); ?>"+"/"+subcategory_id+"/"+subcategory_name;
                    }, 2000);
                } else {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/daily_shiurim_set_date.blade.php ENDPATH**/ ?>