...
<html>
    ...
    <body id="upp">
        ...
        <div class="mod-container" id="modal">
            ...
            <div class="modal">
             <div class="sErr text-center" style="text-center;"></div>
                ...
                <div class="modal-form">
                    <form action="get">
                        <div class="form-input">
                            ...
                            <input placeholder="Enter your name" id="name" class="input" type="text" name="name" id="">
                        </div>
                        <div class="form-input">
                            <span class="label">Email</span>
                            <input placeholder="Enter your email" id="email" class="input" type="email" name="name" id="">
                        </div>
                        <div class="form-input">
                            <span class="label">Phone Number</span>
                            <input placeholder="Enter phone number" id="phone" class="input" type="number" name="name" id="">
                        </div>
                ...
                <div onclick="triggerModal();" class="modal-close">
        ...
        <div class="container70 flex section8 c-sm-90" id="section8">
            ...
            <h1>
                Want to know more? <br> Let's get connected.
            </h1>
            <div>
                <div class="cntc-btn" >
                    <button class="btn cntc" onclick="triggerModal();">
                        Contact Us
                    </button>
                </div>
            </div>
...
</script><?php /**PATH C:\laragon\www\admin\resources\views/frontend/index.blade.php ENDPATH**/ ?>