            ...
            <div class="col-md-12 pd0 float-left mb-4">
                <div class="card card-primary">
                    ...
                    <?php endif; ?>
                     ...
                     <?php endif; ?>
                    <div class="card-body">
                        <form method="post" action="<?php echo e(url('save-parshiyos-file')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="parshiyos row justify-content-between mb-4 d-none">
                                ...
                                <!-- <input type="hidden" class="form-control" id="category_id" name="category_id" value="<?php echo e($cat->id); ?>"> -->
                                <div class="col-md-6">
                                    <div class="form-group row nShow mb-1">
                                     ...
                                     <div class="yomim_yovim form-group row nShow mb-1 d-none">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control" name="holiday_id" id="holiday_id">
                                                <option>--Select--</option>
                                                <?php $__currentLoopData = $holiday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($val->id); ?>"><?php echo e($val->holiday_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\admin\resources\views/home/parshiyos_file_upload.blade.php ENDPATH**/ ?>