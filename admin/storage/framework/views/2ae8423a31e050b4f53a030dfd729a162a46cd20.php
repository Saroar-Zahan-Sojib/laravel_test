            ...
            <div class="col-md-12 pd0 float-left mb-4">
                <div class="card card-primary">
                    ...
                    <?php endif; ?>
                     ...
                     <?php endif; ?>
                    <div class="card-body">
                        <form method="post" action="<?php echo e(url('save-lecture')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="lecture">
                                <div class="form-group row mb-1">
                                    <label class="col-md-2">Lecture Name</label>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" name="lecture[]" placeholder="Lecture Name" id="lecture">
                                    </div>
                                    <div class="col-md-1">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\laravel\admin\resources\views/home/create_lecture.blade.php ENDPATH**/ ?>