    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{url('create-category-type')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
              <span class="menu-title">Category Type</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('create-subcatagory')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
              <span class="menu-title">Subcategory</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('create-content')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
              <span class="menu-title">Content</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('create-sub-content')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
              <span class="menu-title">Add Speaker</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('create-lecture')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
              <span class="menu-title">Section</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('create-speaker')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{url('feature-file-upload')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
              <span class="menu-title">Feature File Upload</span>
            </a>
          </li>
         <!--  <li class="nav-item">
            <a class="nav-link" href="{{url('nigunim')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
              <span class="menu-title">Nigunim</span>
            </a>
          </li> -->
         <!--  <li class="nav-item">
            <a class="nav-link" href="{{url('muggidei-shiurim')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
          ...
          <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                    <li class="nav-item">
                        <a href="{{url('create-nigunim-category')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Category</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('create-nigunim-album')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Nigunim Album</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('create-nigunim-file')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
            ...
            <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                    <li class="nav-item">
                        <a href="{{url('create-story-category')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Story Category</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('add-main-story-file')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{url('add-feature-for-story')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
            ...
            <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                    <li class="nav-item">
                        <a href="{{url('create-farbrengen-month')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Month</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('create-farbrengen-date')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{url('add-farbrengen-file')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
            ...
            <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                    <li class="nav-item">
                        <a href="{{url('create-topics-category')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Category</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{url('create-parshioys-type')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Parshioys Type</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('create-parshioys-content')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Parshioys Content</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('create-parshioys-group')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{url('parshioys-file-upload')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{url('yomim-tovim-holiday')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Yomim Tovim Holiday </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('add-current-parsha')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{url('set-upcoming-holiday')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Set Upcoming Holiday </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('add-parshas-hashavua-feature')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
            ...
            <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                    <li class="nav-item">
                        <a href="{{url('kol-rabeinu')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Category</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{url('month')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Month</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{url('niggun-category')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{url('create-stories-category')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Add Stories Category </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('topics-of-sichos')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{url('kol-rabeinu-file-upload')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
                    <span class="menu-title">Kol Rabeinu File Upload </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('add-feature-for-kol-rabeinu')}}" class="nav-link">
                            <i class="mdi mdi-window-restore menu-icon"></i>
            ...
            <li class="nav-item">
            <a class="nav-link" href="{{url('daily-shiurim')}}">
              <i class="mdi mdi-window-restore menu-icon"></i>
