            ...
            <div class="col-md-6 pd0 float-left">
                <div class="card card-primary">
                    ...
                    @endif
                     ...
                     @endif
                    <div class="card-body">
                        <form method="post" action="{{ url('save-parshiyos-content') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="form-group row nShow mb-1">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="main_cat_id" name="main_cat_id" value="{{$main_cat->id}}">
