                        ...
                        @csrf -->
                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    <td>{{$chumas->subcategory_name}}</td>
                                    <td><a href="set-daily-shurim-date/{{$chumas->id}}/{{$chumas->subcategory_name}}" class="btn btn-primary">Set Date</a> </td>
                                  </tr>
                                  <tr>
                                    <td>{{$tanaya->content_name}}</td>
                                    <td><a href="set-daily-shurim-date/{{$tanaya->id}}/{{$tanaya->content_name}}" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td>{{$hayom_yom->content_name}}</td>
                                    <td><a href="set-daily-shurim-date/{{$hayom_yom->id}}/{{$hayom_yom->content_name}}" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td>{{$inyonei_geulah->category_name}}</td>
                                    <td><a href="set-daily-shurim-date/{{$inyonei_geulah->id}}/{{$inyonei_geulah->category_name}}" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td>{{$rambam->subcategory_name}}</td>
                                    <td><a href="set-daily-shurim-date/{{$rambam->id}}/{{$rambam->subcategory_name}}" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                  <tr>
                                    <td>{{$dof_yomi->subcategory_name}}</td>
                                    <td><a href="set-daily-shurim-date/{{$dof_yomi->id}}/{{$dof_yomi->subcategory_name}}" class="btn btn-primary">Set Date</a></td>
                                  </tr>
                                </table>
