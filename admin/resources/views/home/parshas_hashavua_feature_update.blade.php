                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    ...
                                    <td><a id="{{$dt->id}}" category_id="{{$dt->content_id}}" href="javascript:" class="btn btn-info btn-sm edit"> <i class='fa fa-save'></i> Submit </a></td>
                                  </tr>
                                  @endforeach
...
<script type="text/javascript">
     $(document).on("click", ".edit", function(){
      ...
      $.ajaxSetup({
        ...
        $.ajax({
            url: "{{ url('parshas-hashvua-feature-update') }}",
            method: "post",
            data: {
                id: id,
                status: status,
            ...
            success: function(rsp){
                ...
                if(rsp.error == false){
                    ...
                    setTimeout(function(){
                            window.location = "{{ url('set-feature-parshas-hashavua') }}"+"/"+category_id;
                    }, 2000);
                } else {
