                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    ...
                                    <td><a id="{{$dt->id}}" content_name="{{$dt->content_name}}" content_id="{{$dt->content_id}}" href="javascript:" class="btn btn-info btn-sm edit"> <i class='fa fa-save'></i> Submit </a></td>
                                  </tr>
                                  @endforeach
        ...
        $.ajax({
            ...
            success: function(rsp){
                ...
                if(rsp.error == false){
                    ...
                    setTimeout(function(){
                            window.location = "{{ url('set-daily-shurim-date') }}"+"/"+content_id+"/"+content_name;
                    }, 2000);
                } else {
