                            ...
                            <div class="row justify-content-between mb-4">
                                <table>
                                  ...
                                  <tr>
                                    ...
                                    <td><a id="{{$dt->id}}" subcategory_name="{{$dt->subcategory_name}}" subcategory_id="{{$dt->subcategory_id}}" href="javascript:" class="btn btn-info btn-sm edit"> <i class='fa fa-save'></i> Submit </a></td>
                                  </tr>
                                  @endforeach
...
<script type="text/javascript">
     $(document).on("click", ".edit", function(){
      ...
      $.ajaxSetup({
        ...
        $.ajax({
            url: "{{ url('daily-seuirm-val-update') }}",
            method: "post",
            data: {
                id: id,
                date: date,
            ...
            success: function(rsp){
                ...
                if(rsp.error == false){
                    ...
                    setTimeout(function(){
                            window.location = "{{ url('set-daily-shurim-date') }}"+"/"+subcategory_id+"/"+subcategory_name;
                    }, 2000);
                } else {
