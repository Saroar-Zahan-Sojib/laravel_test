            ...
            <div class="col-md-12 pd0 float-left mb-4">
                <div class="card card-primary">
                    ...
                    @endif
                     ...
                     @endif
                    <div class="card-body">
                        <form method="post" action="{{ url('save-muggidei-shiurim') }}" enctype="multipart/form-data">
                        @csrf
                      ...
                      <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @else 
                                <td class="video"><video width="100px" height="80" muted><source src="{{asset('/storage/video/'.$dt->video)}}" type="video/mp4"></video></td>   
                                @endif    
