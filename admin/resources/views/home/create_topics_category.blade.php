            ...
            <div class="col-md-6 pd0 float-left">
                <div class="card card-primary">
                    ...
                    @endif
                     ...
                     @endif
                    <div class="card-body">
                        <form method="post" action="{{ url('save-topics-category') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="form-group row nShow mb-1">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="hidden" class="form-control" id="topic_id" name="topic_id" value="{{$cat->id}}">
                                </div>
                            </div>
